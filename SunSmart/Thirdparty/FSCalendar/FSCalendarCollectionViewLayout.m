...
- (void)prepareLayout
{
            ...
            if (!self.calendar.floatingMode) {
                switch (self.calendar.transitionCoordinator.representingScope) {
                    case FSCalendarScopeMonth: {
                        height = (self.collectionView.fs_height-self.sectionInsets.top-self.sectionInsets.bottom)/_rowCount;
                        break;
                    }
    ...
    free(self.heights);
    self.heights = ({
        NSInteger rowCount = self.calendar.transitionCoordinator.representingScope == FSCalendarScopeWeek ? 1 : _rowCount;
    ...
    if (!self.calendar.floatingMode) {
        ...
        switch (self.scrollDirection) {
            case UICollectionViewScrollDirectionHorizontal: {
                ...
                NSInteger numberOfRows = self.calendar.transitionCoordinator.representingScope == FSCalendarScopeMonth ? _rowCount : 1;
