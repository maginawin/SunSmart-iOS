...
//        guard totalPercent <= 1 else { fatalError("总百分比 不能超过1") }
    ...
    static let demo: LYPieVisual = {
        let tempColors = [#colorLiteral(red: 0.7960784314, green: 0.8705882353, blue: 0.2980392157, alpha: 1), #colorLiteral(red: 0.9450980392, green: 0.6705882353, blue: 0.06666666667, alpha: 1), #colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1), #colorLiteral(red: 0.2392156863, green: 0.8431372549, blue: 1, alpha: 1), #colorLiteral(red: 0.9490196078, green: 0.831372549, blue: 0.05490196078, alpha: 1), #colorLiteral(red: 1, green: 0.4392156863, blue: 0.2392156863, alpha: 1)]
        let tempDatas = [
            LYPieData(title: "Group1", detail: "5%", percent: 0.1),
            LYPieData(title: "Group2", detail: "15%", percent: 0.2),
            LYPieData(title: "Group3", detail: "20%", percent: 0.1),
            LYPieData(title: "Group4", detail: "20%", percent: 0.2),
            LYPieData(title: "Group5", detail: "10%", percent: 0.1),
            LYPieData(title: "Not in Group", detail: "30%", percent: 0.3)
        ]
