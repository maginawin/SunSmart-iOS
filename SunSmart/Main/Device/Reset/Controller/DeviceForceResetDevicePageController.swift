...
class DeviceForceResetDevicePageController: WMPageController {
    ...
    private let vcTitles: [String] = ["flashlight".localizedString, "motion".localizedString, "mesh_network".localizedString]
...
extension DeviceForceResetDevicePageController {
    ...
    override func pageController(_ pageController: WMPageController, viewControllerAt index: Int) -> UIViewController {
        ...
        var resetMode: DeviceResetDeviceStepController.ResetMode = .flashlight
        switch index {
        case 1:
            resetMode = .motion
        case 2:
            resetMode = .meshNetwork
        default:
            break
        }
        
        let vc = DeviceResetDeviceStepController(resetMode: resetMode)
//        DeviceForceResetDeviceController(resetMode: index == 0 ? .flashlight : .motion)
//        vc.delegate = self
        return vc
    }
