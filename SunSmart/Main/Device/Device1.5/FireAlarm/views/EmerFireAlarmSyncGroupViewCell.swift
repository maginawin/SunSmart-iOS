//
//  EmerFireAlarmSyncGroupViewCell.swift
//  SunSmart
//
...
protocol EmerFireAlarmSyncGroupViewCellDelegate: AnyObject {
...
class EmerFireAlarmSyncGroupViewCell: UITableViewCell {
    ...
    weak var delegate: EmerFireAlarmSyncGroupViewCellDelegate?
    
    var groupModel: EmerFireAlarmSyncGroupModel! {
        didSet {
