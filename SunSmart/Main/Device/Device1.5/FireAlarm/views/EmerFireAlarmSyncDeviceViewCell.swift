//
//  EmerFireAlarmSyncDeviceViewCell.swift
//  SunSmart
//
...
protocol EmerFireAlarmSyncDeviceViewCellDelegate: AnyObject {
    ...
    /// 状态图标点击回调
    func cell(_ cell: EmerFireAlarmSyncDeviceViewCell, stateImageClickAction model: EmerFireAlarmSyncDeviceModel)
    
}

extension EmerFireAlarmSyncDeviceViewCellDelegate {
    
    /// 状态图标点击回调
    func cell(_ cell: EmerFireAlarmSyncDeviceViewCell, stateImageClickAction model: EmerFireAlarmSyncDeviceModel) {}
}

class EmerFireAlarmSyncDeviceViewCell: UITableViewCell {
    ...
    var lineView: UIView!
    weak var delegate: EmerFireAlarmSyncDeviceViewCellDelegate?
    
    var model: EmerFireAlarmSyncDeviceModel! {
        didSet {
