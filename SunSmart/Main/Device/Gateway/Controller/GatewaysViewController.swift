...
class GatewaysViewController: UIViewController {
...
//        }
    ...
    private func updateDevicesEmptyUI() {
        ...
        if true {
            ...
            collectionView.showEmptyDataView(title: "no_gateways".localizedString, tipText: "no_gateways_message".localizedString, position: .center, bottomMargin: SCRYFit(30))
...
extension GatewaysViewController: SpaceFunctionFooterViewDelegate {
