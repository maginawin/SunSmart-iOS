...
//            }
            ...
            let gatewayModel = GatewayModel(siteId: self.site.id, name: node.name ?? "", address: node.primaryUnicastAddress, mac: mac, lastUpdate: Int64(Date().timeIntervalSince1970), activate: true)
            gatewayModel.save()
